...
// PPB PORE Parameters
    real poreX; // PPB Coordinates of the centre of the pore  
    real poreY; //
    real poreZ; //
    real poreR; // PPB Radius of the pore
    real poreL; // PPB Pore length
    real poreh1; //Inner edge of the cone. This is the length between the centre and the inner edge along the z direction
    real poreh2; // Outer edge of the cone. This is the length between the centre and the outer edge along the z direction
    real poreAlpha; // Angle of the cone;

    real porePar6; // PPB The 6 parameter for the 6-12 potential
    real porePar12; // PPB The 12 parameter for the 6-12 potential
