...
#define NFILE asize(fnm)
    ...
    gmx_bool      bPORE         = FALSE; //PPB flag indicates whether the pore is on
    ...
    t_pargs       pa[] = {
        ...
        { "-pore", FALSE, etBOOL, {&bPORE},
          "Use the finite pore potential" } //PPB Pore option. use the -pore option to switch on the pore
    };
    gmx_edsam_t   ed;
    ...
    Flags = Flags | (bPORE         ? MD_PORE         : 0); //PPB pore flag
    ...
    rc = mdrunner(&hw_opt, fplog, cr, NFILE, fnm, oenv, bVerbose, bCompact,
                  ...
                  pforce, cpt_period, max_hours, deviceOptions, Flags, bPORE); // PPB
