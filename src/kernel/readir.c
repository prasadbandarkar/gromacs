...
#undef CTYPE
    ...
    //PPB PORE parameters
    //CODE that reads the parameters from the mdpfile
    CCTYPE ("PORE parameters");
    RTYPE ("poreX",ir->poreX, -1.0);
    RTYPE ("poreY",ir->poreY, -1.0);
    RTYPE ("poreZ",ir->poreZ, -1.0);
    RTYPE ("poreR",ir->poreR, -1.0);
    RTYPE ("poreL",ir->poreL, -1.0);
    RTYPE ("poreh1",ir->poreh1, -1.0);
    RTYPE ("poreh2",ir->poreh2, -1.0);
    RTYPE ("poreAlpha",ir->poreAlpha, 30.0);
    RTYPE ("porePar6",ir->porePar6, 0.0);
    RTYPE ("porePar12",ir->porePar12, 0.0);
