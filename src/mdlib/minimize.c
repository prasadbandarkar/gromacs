...
static void evaluate_energy(FILE *fplog, gmx_bool bVerbose, t_commrec *cr,
                            ...
                            gmx_large_int_t count, gmx_bool bFirst,gmx_bool bPORE) //PPB_2
{
    real     t;
    gmx_bool bNS;
    int      nabnsb;
    ...
    do_force(fplog, cr, inputrec,
             ...
             (bNS ? GMX_FORCE_NS | GMX_FORCE_DO_LR : 0),bPORE); //PPB_2
	     ...
	     gmx_bool bPORE) // PPB_2
{
    ...
    evaluate_energy(fplog, bVerbose, cr,
                    ...
                    mu_tot, enerd, vir, pres, -1, TRUE, bPORE); // PPB_2
    where();
    ...
    for (step = 0; (number_steps < 0 || (number_steps >= 0 && step <= number_steps)) && !converged; step++)
    {
        ...
        evaluate_energy(fplog, bVerbose, cr,
                        ...
                        inputrec, nrnb, wcycle, gstat,
                        vsite, constr, fcd, graph, mdatoms, fr,
                        mu_tot, enerd, vir, pres, -1, FALSE, bPORE ); // PPB_2
                ...
                gmx_runtime_t *runtime, gmx_bool bPORE) // PPB_2
{
    ...
    for (step = 0; (number_steps < 0 || (number_steps >= 0 && step <= number_steps)) && !converged; step++)
    {
        ...
        evaluate_energy(fplog, bVerbose, cr,
                        ...
                        inputrec, nrnb, wcycle, gstat,
                        vsite, constr, fcd, graph, mdatoms, fr,
                        mu_tot, enerd, vir, pres, step, FALSE,bPORE); // PPB_2
        EpotC = ems.epot;
                ...
                gmx_runtime_t *runtime, gmx_bool bPORE) // PPB_2
{
    ...
    while (!bDone && !bAbort)
    {
        ...
        evaluate_energy(fplog, bVerbose, cr,
                        ...
                        inputrec, nrnb, wcycle, gstat,
                        vsite, constr, fcd, graph, mdatoms, fr,
                        mu_tot, enerd, vir, pres, count, count == 0, bPORE); //PPB_2
    ...
    for (atom = cr->nodeid; atom < natoms; atom += nnodes)
    {
        ...
        for (d = 0; d < DIM; d++)
        {
            ...
            evaluate_energy(fplog, bVerbose, cr,
                            ...
                            inputrec, nrnb, wcycle, gstat,
                            vsite, constr, fcd, graph, mdatoms, fr,
                            mu_tot, enerd, vir, pres, atom*2, FALSE, bPORE); // PPB_2
            ...
            evaluate_energy(fplog, bVerbose, cr,
                            ...
                            inputrec, nrnb, wcycle, gstat,
                            vsite, constr, fcd, graph, mdatoms, fr,
                            mu_tot, enerd, vir, pres, atom*2+1, FALSE, bPORE); // PPB_2
            cr->nnodes = nnodes;
