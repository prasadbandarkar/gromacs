                        ...
                        int file_version, real *fudgeQQ)
{
    ...
    // PPB pore stuff
    gmx_fio_do_real(fio, ir->poreX); //Copy the parameters from the mdpfile inputrec
    gmx_fio_do_real(fio, ir->poreY);
    gmx_fio_do_real(fio, ir->poreZ);
    gmx_fio_do_real(fio, ir->poreR);
    gmx_fio_do_real(fio, ir->poreL);
    gmx_fio_do_real(fio, ir->poreh1);
    gmx_fio_do_real(fio, ir->poreh2);
    gmx_fio_do_real(fio, ir->poreAlpha);
    gmx_fio_do_real(fio, ir->porePar6);
    gmx_fio_do_real(fio, ir->porePar12);
